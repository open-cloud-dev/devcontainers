...
Pre-build development container images
...
> `ghcr.io/open-cloud-dev/devcontainers/base`
...
> `ghcr.io/open-cloud-dev/devcontainers/full`
...
{
  "name": "devcontainer",
  "image": "ghcr.io/open-cloud-dev/devcontainers/full"
}
```
